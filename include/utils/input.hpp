#ifndef VIRTUAL_GALAXY_INPUT_HPP
#define VIRTUAL_GALAXY_INPUT_HPP
...
private:
    ...
    static const int AmountOfKeys = 322;
    static const int AmountOfMouseButtons = 3;

    uint8* _keysUp {nullptr};
    uint8* _keysDown {nullptr};

    uint8* _mouseButtonsDown {nullptr};
    uint8* _mouseButtonsUp {nullptr};

    bool _isQuit {false};
};

#endif //VIRTUAL_GALAXY_INPUT_HPP
